...
const STEPS: Step[] = [
  ...
  },
  {
    ...
    target: ".vx-side-nav__item:nth-child(2), .vx-bottom-nav__btn:nth-child(2)",
    side: "right",
  },
  {
    title: "Markets — Live charts",
    body: "Real-time prices, technicals, and a 90-day chart for any ticker. Click 'Open' on the chart card to get a dedicated, shareable page.",
    target: ".vx-side-nav__item:nth-child(1), .vx-bottom-nav__btn:nth-child(1)",
    side: "right",
  },
  {
    title: "Watchlist & alerts",
    body: "Star any ticker to track it. Set price alerts that email you when targets hit.",
    target: ".vx-side-nav .vx-side-nav__item:nth-child(7), .vx-bottom-nav__btn:nth-child(3)",
    side: "right",
  },
  {
